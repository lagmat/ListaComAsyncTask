package br.com.erich.listacomasynctask;
...
import br.com.erich.listacomasynctask.R;
import br.com.erich.listacomasynctask.adapter.AndroidAdapter;
import br.com.erich.listacomasynctask.listener.OnItemClickListener;
import br.com.erich.listacomasynctask.model.Android;
    ...
    private void setUpRecyclerView(List<Android> data) {
        ...
        mAdapter.setClickListener(new OnItemClickListener() {
            public void onClick(View view, int position) {
                ...
                i.putExtra(Android.TAG_ANDROID, android);
                startActivity(i);
